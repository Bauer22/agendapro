  ...
  async function exportPDF() {
    try {
      ...
      autoTable(doc, {
        ...
        body: [...rep].sort(function sortWoodDetalhe(a,b){ var da=(a.data_entrada||'')+''; var db=(b.data_entrada||'')+''; if(da!==db) return da.localeCompare(db); var ha=((a.unload_time||a.arrival_time||'')+''); var hb=((b.unload_time||b.arrival_time||'')+''); return ha.localeCompare(hb); }).map(e=>[
          fmtD(e.data_entrada),
        ...
        {view && (
          <div className="flex flex-col gap-2">
            {[
              ...
              ['R$ / tonelada', view.unit_value ? `R$ ${parseFloat(view.unit_value).toLocaleString('pt-BR',{minimumFractionDigits:2,maximumFractionDigits:2})}` : '—'],
